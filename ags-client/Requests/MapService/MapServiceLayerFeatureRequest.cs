...
{
    public class MapServiceLayerFeatureRequest<TF, TG, TA> : BaseRequest
        ...
        where TA : IRestAttributes
    {
        ...
        public MapServiceLayerFeatureRequest(int objectId)
        {
            _objectId = objectId;
        }

        public FeatureResource<TF, TG, TA> Execute(AgsClient client, LayerOrTableResource parent)
        {
